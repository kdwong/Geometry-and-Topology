...
We will study global properties of a geometric object, i.e., the distance between 2 points in an object is totally ignored. For example, the objects shown below are essentially invariant under a certain kind of transformation:

\begin{center}
\includegraphics[width=0.5\textwidth]{images/ch1_cow.jpg}
\end{center}

Another example is that the coffee cup and the doughnut have the same topology:
